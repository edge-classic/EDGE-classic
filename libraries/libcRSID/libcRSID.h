...
extern "C"
{
    ...
    cRSID_C64instance *cRSID_init(unsigned short samplerate, unsigned char hq_waves); // init emulation objects and sound
...
cRSID_C64instance *cRSID_init(unsigned short samplerate, unsigned char hq_waves)
{
