...
constexpr float kFrictionDefault     = 0.90625f;
constexpr float kMoveFactorDefault   = 0.03125f;
constexpr float kMoveFactorMinimum   = 0.000488281f;
constexpr float kHighFrictionFactor  = 0.228881836f;
