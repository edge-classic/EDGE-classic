...
// DDF_StateFindLabel
//
int DDF_StateFindLabel(const std::vector<StateRange> &group, const char *label, bool quiet)
{
...
// DDF_StateReadState
//
void DDF_StateReadState(const char *info, const char *label, std::vector<StateRange> &group, int *state_num, int index,
