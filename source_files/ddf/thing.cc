...
{
    {"INVENTORY01", INV_01, 0},
    {"INVENTORY02", INV_02, 0},
    {"INVENTORY03", INV_03, 0},
    {"INVENTORY04", INV_04, 0},
    {"INVENTORY05", INV_05, 0},
    {"INVENTORY06", INV_06, 0},
    {"INVENTORY07", INV_07, 0},
    {"INVENTORY08", INV_08, 0},
    {"INVENTORY09", INV_09, 0},
    {"INVENTORY10", INV_10, 0},
    {"INVENTORY11", INV_11, 0},
    {"INVENTORY12", INV_12, 0},
    {"INVENTORY13", INV_13, 0},
    {"INVENTORY14", INV_14, 0},
    {"INVENTORY15", INV_15, 0},
    {"INVENTORY16", INV_16, 0},
    {"INVENTORY17", INV_17, 0},
    {"INVENTORY18", INV_18, 0},
    {"INVENTORY19", INV_19, 0},
    {"INVENTORY20", INV_20, 0},
    {"INVENTORY21", INV_21, 0},
    {"INVENTORY22", INV_22, 0},
    {"INVENTORY23", INV_23, 0},
    {"INVENTORY24", INV_24, 0},
    {"INVENTORY25", INV_25, 0},
	{"INVENTORY26", INV_26, 0},
    {"INVENTORY27", INV_27, 0},
    {"INVENTORY28", INV_28, 0},
    {"INVENTORY29", INV_29, 0},
    {"INVENTORY30", INV_30, 0},
    {"INVENTORY31", INV_31, 0},
    {"INVENTORY32", INV_32, 0},
    {"INVENTORY33", INV_33, 0},
    {"INVENTORY34", INV_34, 0},
    {"INVENTORY35", INV_35, 0},
    {"INVENTORY36", INV_36, 0},
    {"INVENTORY37", INV_37, 0},
    {"INVENTORY38", INV_38, 0},
    {"INVENTORY39", INV_39, 0},
    {"INVENTORY40", INV_40, 0},
    {"INVENTORY41", INV_41, 0},
    {"INVENTORY42", INV_42, 0},
    {"INVENTORY43", INV_43, 0},
    {"INVENTORY44", INV_44, 0},
    {"INVENTORY45", INV_45, 0},
    {"INVENTORY46", INV_46, 0},
    {"INVENTORY47", INV_47, 0},
    {"INVENTORY48", INV_48, 0},
    {"INVENTORY49", INV_49, 0},
    {"INVENTORY50", INV_50, 0},	
    {"INVENTORY51", INV_51, 0},
    {"INVENTORY52", INV_52, 0},
    {"INVENTORY53", INV_53, 0},
    {"INVENTORY54", INV_54, 0},
    {"INVENTORY55", INV_55, 0},
    {"INVENTORY56", INV_56, 0},
    {"INVENTORY57", INV_57, 0},
    {"INVENTORY58", INV_58, 0},
    {"INVENTORY59", INV_59, 0},
    {"INVENTORY60", INV_60, 0},
    {"INVENTORY61", INV_61, 0},
    {"INVENTORY62", INV_62, 0},
    {"INVENTORY63", INV_63, 0},
    {"INVENTORY64", INV_64, 0},
    {"INVENTORY65", INV_65, 0},
    {"INVENTORY66", INV_66, 0},
    {"INVENTORY67", INV_67, 0},
    {"INVENTORY68", INV_68, 0},
    {"INVENTORY69", INV_69, 0},
    {"INVENTORY70", INV_70, 0},
    {"INVENTORY71", INV_71, 0},
    {"INVENTORY72", INV_72, 0},
    {"INVENTORY73", INV_73, 0},
    {"INVENTORY74", INV_74, 0},
    {"INVENTORY75", INV_75, 0},	
    {"INVENTORY76", INV_76, 0},
    {"INVENTORY77", INV_77, 0},
    {"INVENTORY78", INV_78, 0},
    {"INVENTORY79", INV_79, 0},
    {"INVENTORY80", INV_80, 0},
    {"INVENTORY81", INV_81, 0},
    {"INVENTORY82", INV_82, 0},
    {"INVENTORY83", INV_83, 0},
    {"INVENTORY84", INV_84, 0},
    {"INVENTORY85", INV_85, 0},
    {"INVENTORY86", INV_86, 0},
    {"INVENTORY87", INV_87, 0},
    {"INVENTORY88", INV_88, 0},
    {"INVENTORY89", INV_89, 0},
    {"INVENTORY90", INV_90, 0},
    {"INVENTORY91", INV_91, 0},
    {"INVENTORY92", INV_92, 0},
    {"INVENTORY93", INV_93, 0},
    {"INVENTORY94", INV_94, 0},
    {"INVENTORY95", INV_95, 0},
    {"INVENTORY96", INV_96, 0},
    {"INVENTORY97", INV_97, 0},
    {"INVENTORY98", INV_98, 0},
    {"INVENTORY99", INV_99, 0},
    {NULL, 0, 0}
};
...
const specflags_t counter_types[] =
{
    ...
    {"COUNTER26", COUNT_26, 0},
    {"COUNTER27", COUNT_27, 0},
    {"COUNTER28", COUNT_28, 0},
    {"COUNTER29", COUNT_29, 0},
    {"COUNTER30", COUNT_30, 0},
    {"COUNTER31", COUNT_31, 0},
    {"COUNTER32", COUNT_32, 0},
    {"COUNTER33", COUNT_33, 0},
    {"COUNTER34", COUNT_34, 0},
    {"COUNTER35", COUNT_35, 0},
    {"COUNTER36", COUNT_36, 0},
    {"COUNTER37", COUNT_37, 0},
    {"COUNTER38", COUNT_38, 0},
    {"COUNTER39", COUNT_39, 0},
    {"COUNTER40", COUNT_40, 0},
    {"COUNTER41", COUNT_41, 0},
    {"COUNTER42", COUNT_42, 0},
    {"COUNTER43", COUNT_43, 0},
    {"COUNTER44", COUNT_44, 0},
    {"COUNTER45", COUNT_45, 0},
    {"COUNTER46", COUNT_46, 0},
    {"COUNTER47", COUNT_47, 0},
    {"COUNTER48", COUNT_48, 0},
    {"COUNTER49", COUNT_49, 0},
    {"COUNTER50", COUNT_50, 0},	
    {"COUNTER51", COUNT_51, 0},
    {"COUNTER52", COUNT_52, 0},
    {"COUNTER53", COUNT_53, 0},
    {"COUNTER54", COUNT_54, 0},
    {"COUNTER55", COUNT_55, 0},
    {"COUNTER56", COUNT_56, 0},
    {"COUNTER57", COUNT_57, 0},
    {"COUNTER58", COUNT_58, 0},
    {"COUNTER59", COUNT_59, 0},
    {"COUNTER60", COUNT_60, 0},
    {"COUNTER61", COUNT_61, 0},
    {"COUNTER62", COUNT_62, 0},
    {"COUNTER63", COUNT_63, 0},
    {"COUNTER64", COUNT_64, 0},
    {"COUNTER65", COUNT_65, 0},
    {"COUNTER66", COUNT_66, 0},
    {"COUNTER67", COUNT_67, 0},
    {"COUNTER68", COUNT_68, 0},
    {"COUNTER69", COUNT_69, 0},
    {"COUNTER70", COUNT_70, 0},
    {"COUNTER71", COUNT_71, 0},
    {"COUNTER72", COUNT_72, 0},
    {"COUNTER73", COUNT_73, 0},
    {"COUNTER74", COUNT_74, 0},
    {"COUNTER75", COUNT_75, 0},	
    {"COUNTER76", COUNT_76, 0},
    {"COUNTER77", COUNT_77, 0},
    {"COUNTER78", COUNT_78, 0},
    {"COUNTER79", COUNT_79, 0},
    {"COUNTER80", COUNT_80, 0},
    {"COUNTER81", COUNT_81, 0},
    {"COUNTER82", COUNT_82, 0},
    {"COUNTER83", COUNT_83, 0},
    {"COUNTER84", COUNT_84, 0},
    {"COUNTER85", COUNT_85, 0},
    {"COUNTER86", COUNT_86, 0},
    {"COUNTER87", COUNT_87, 0},
    {"COUNTER88", COUNT_88, 0},
    {"COUNTER89", COUNT_89, 0},
    {"COUNTER90", COUNT_90, 0},
    {"COUNTER91", COUNT_91, 0},
    {"COUNTER92", COUNT_92, 0},
    {"COUNTER93", COUNT_93, 0},
    {"COUNTER94", COUNT_94, 0},
    {"COUNTER95", COUNT_95, 0},
    {"COUNTER96", COUNT_96, 0},
    {"COUNTER97", COUNT_97, 0},
    {"COUNTER98", COUNT_98, 0},
    {"COUNTER99", COUNT_99, 0},
    {NULL, 0, 0}
};
