...
const DDFSpecialFlags inv_types[] = { { "INVENTORY01", kInventoryType01, 0 },
                                      { "INVENTORY02", kInventoryType02, 0 },
                                      { "INVENTORY03", kInventoryType03, 0 },
                                      { "INVENTORY04", kInventoryType04, 0 },
                                      { "INVENTORY05", kInventoryType05, 0 },
                                      { "INVENTORY06", kInventoryType06, 0 },
                                      { "INVENTORY07", kInventoryType07, 0 },
                                      { "INVENTORY08", kInventoryType08, 0 },
                                      { "INVENTORY09", kInventoryType09, 0 },
                                      { "INVENTORY10", kInventoryType10, 0 },
                                      { "INVENTORY11", kInventoryType11, 0 },
                                      { "INVENTORY12", kInventoryType12, 0 },
                                      { "INVENTORY13", kInventoryType13, 0 },
                                      { "INVENTORY14", kInventoryType14, 0 },
                                      { "INVENTORY15", kInventoryType15, 0 },
                                      { "INVENTORY16", kInventoryType16, 0 },
                                      { "INVENTORY17", kInventoryType17, 0 },
                                      { "INVENTORY18", kInventoryType18, 0 },
                                      { "INVENTORY19", kInventoryType19, 0 },
                                      { "INVENTORY20", kInventoryType20, 0 },
                                      { "INVENTORY21", kInventoryType21, 0 },
                                      { "INVENTORY22", kInventoryType22, 0 },
                                      { "INVENTORY23", kInventoryType23, 0 },
                                      { "INVENTORY24", kInventoryType24, 0 },
                                      { "INVENTORY25", kInventoryType25, 0 },
                                      { "INVENTORY26", kInventoryType26, 0 },
                                      { "INVENTORY27", kInventoryType27, 0 },
                                      { "INVENTORY28", kInventoryType28, 0 },
                                      { "INVENTORY29", kInventoryType29, 0 },
                                      { "INVENTORY30", kInventoryType30, 0 },
                                      { "INVENTORY31", kInventoryType31, 0 },
                                      { "INVENTORY32", kInventoryType32, 0 },
                                      { "INVENTORY33", kInventoryType33, 0 },
                                      { "INVENTORY34", kInventoryType34, 0 },
                                      { "INVENTORY35", kInventoryType35, 0 },
                                      { "INVENTORY36", kInventoryType36, 0 },
                                      { "INVENTORY37", kInventoryType37, 0 },
                                      { "INVENTORY38", kInventoryType38, 0 },
                                      { "INVENTORY39", kInventoryType39, 0 },
                                      { "INVENTORY40", kInventoryType40, 0 },
                                      { "INVENTORY41", kInventoryType41, 0 },
                                      { "INVENTORY42", kInventoryType42, 0 },
                                      { "INVENTORY43", kInventoryType43, 0 },
                                      { "INVENTORY44", kInventoryType44, 0 },
                                      { "INVENTORY45", kInventoryType45, 0 },
                                      { "INVENTORY46", kInventoryType46, 0 },
                                      { "INVENTORY47", kInventoryType47, 0 },
                                      { "INVENTORY48", kInventoryType48, 0 },
                                      { "INVENTORY49", kInventoryType49, 0 },
                                      { "INVENTORY50", kInventoryType50, 0 },
                                      { "INVENTORY51", kInventoryType51, 0 },
                                      { "INVENTORY52", kInventoryType52, 0 },
                                      { "INVENTORY53", kInventoryType53, 0 },
                                      { "INVENTORY54", kInventoryType54, 0 },
                                      { "INVENTORY55", kInventoryType55, 0 },
                                      { "INVENTORY56", kInventoryType56, 0 },
                                      { "INVENTORY57", kInventoryType57, 0 },
                                      { "INVENTORY58", kInventoryType58, 0 },
                                      { "INVENTORY59", kInventoryType59, 0 },
                                      { "INVENTORY60", kInventoryType60, 0 },
                                      { "INVENTORY61", kInventoryType61, 0 },
                                      { "INVENTORY62", kInventoryType62, 0 },
                                      { "INVENTORY63", kInventoryType63, 0 },
                                      { "INVENTORY64", kInventoryType64, 0 },
                                      { "INVENTORY65", kInventoryType65, 0 },
                                      { "INVENTORY66", kInventoryType66, 0 },
                                      { "INVENTORY67", kInventoryType67, 0 },
                                      { "INVENTORY68", kInventoryType68, 0 },
                                      { "INVENTORY69", kInventoryType69, 0 },
                                      { "INVENTORY70", kInventoryType70, 0 },
                                      { "INVENTORY71", kInventoryType71, 0 },
                                      { "INVENTORY72", kInventoryType72, 0 },
                                      { "INVENTORY73", kInventoryType73, 0 },
                                      { "INVENTORY74", kInventoryType74, 0 },
                                      { "INVENTORY75", kInventoryType75, 0 },
                                      { "INVENTORY76", kInventoryType76, 0 },
                                      { "INVENTORY77", kInventoryType77, 0 },
                                      { "INVENTORY78", kInventoryType78, 0 },
                                      { "INVENTORY79", kInventoryType79, 0 },
                                      { "INVENTORY80", kInventoryType80, 0 },
                                      { "INVENTORY81", kInventoryType81, 0 },
                                      { "INVENTORY82", kInventoryType82, 0 },
                                      { "INVENTORY83", kInventoryType83, 0 },
                                      { "INVENTORY84", kInventoryType84, 0 },
                                      { "INVENTORY85", kInventoryType85, 0 },
                                      { "INVENTORY86", kInventoryType86, 0 },
                                      { "INVENTORY87", kInventoryType87, 0 },
                                      { "INVENTORY88", kInventoryType88, 0 },
                                      { "INVENTORY89", kInventoryType89, 0 },
                                      { "INVENTORY90", kInventoryType90, 0 },
                                      { "INVENTORY91", kInventoryType91, 0 },
                                      { "INVENTORY92", kInventoryType92, 0 },
                                      { "INVENTORY93", kInventoryType93, 0 },
                                      { "INVENTORY94", kInventoryType94, 0 },
                                      { "INVENTORY95", kInventoryType95, 0 },
                                      { "INVENTORY96", kInventoryType96, 0 },
                                      { "INVENTORY97", kInventoryType97, 0 },
                                      { "INVENTORY98", kInventoryType98, 0 },
                                      { "INVENTORY99", kInventoryType99, 0 },
                                      { nullptr, 0, 0 } };
...
static DDFSpecialFlags mbf21_specials[] = {
    { "LOGRAV", kMBF21FlagLowGravity, 0 }, { nullptr, 0, 0 }
};
