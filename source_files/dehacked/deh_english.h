...
constexpr const char *kQUITMSG =
    "are you sure you want to\nquit this great game?";
constexpr const char *kLOADNET =
    "you can't do load while in a net game!\n\npress a key.";
constexpr const char *kQLOADNET =
    "you can't quickload during a netgame!\n\npress a key.";
constexpr const char *kQSAVESPOT =
    "you haven't picked a quicksave slot yet!\n\npress a key.";
constexpr const char *kSAVEDEAD =
    "you can't save if you aren't playing!\n\npress a key.";
constexpr const char *kQSPROMPT =
    "quicksave over your game named\n\n'%s'?\n\npress y or n.";
constexpr const char *kQLPROMPT =
    "do you want to quickload the game named\n\n'%s'?\n\npress y or n.";
constexpr const char *kNEWGAME =
    "you can't start a new game\nwhile in a network game.\n\npress a key.";
constexpr const char *kNIGHTMARE =
    "are you sure? this skill level\nisn't even remotely fair.\n\npress y or "
    "n.";
constexpr const char *kSWSTRING =
...
constexpr const char *kGOTMEDINEED =
...
constexpr const char *kGOTREDSKULL = "Picked up a red skull key.";
...
constexpr const char *kPD_YELLOWO =
...
constexpr const char *kSTSTR_BEHOLD =
...
constexpr const char *kP6TEXT =
    "Betcha wondered just what WAS the hardest\n"
    "level we had ready for ya?  Now you know.\n"
    "No one gets out alive.";

constexpr const char *kT1TEXT =
...
constexpr const char *kX_TITLE1 =
    "                         The Ultimate DOOM Startup v%i.%i                 "
    "       ";
constexpr const char *kX_TITLE2 =
    "                          DOOM System Startup v%i.%i                      "
    "    ";
constexpr const char *kX_TITLE3 =
