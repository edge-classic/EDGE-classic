...
langinfo_t lang_list[] =
{
    ...
    { PD_BLUEC, "NeedBlueCardForDoor", "PD_BLUEC", 419, NULL },
    { PD_BLUEK, "NeedBlueForDoor", "PD_BLUEK", 419, NULL },
    { PD_BLUEO, "NeedBlueForObject", "PD_BLUEO", 416, NULL },
    { PD_BLUES, "NeedBlueSkullForDoor", "PD_BLUES", 419, NULL },
    { PD_REDC, "NeedRedCardForDoor", "PD_REDC", 419, NULL },
    { PD_REDK, "NeedRedForDoor", "PD_REDK", 421, NULL },
    { PD_REDO, "NeedRedForObject", "PD_REDO", 417, NULL },
    { PD_REDS, "NeedRedSkullForDoor", "PD_REDS", 421, NULL },
    { PD_YELLOWC, "NeedYellowCardForDoor", "PD_YELLOWC", 420, NULL },
    { PD_YELLOWK, "NeedYellowForDoor", "PD_YELLOWK", 420, NULL },
    { PD_YELLOWS, "NeedYellowSkullForDoor", "PD_YELLOWS", 420, NULL },
