...
langinfo_t lang_list[] =
{
    ...
    { PD_BLUEC, "NeedBlueCardForDoor", "PD_BLUEC", -1, NULL },
    { PD_BLUEK, "NeedBlueForDoor", "PD_BLUEK", 419, NULL },
    { PD_BLUEO, "NeedBlueForObject", "PD_BLUEO", 416, NULL },
    { PD_BLUES, "NeedBlueSkullForDoor", "PD_BLUES", -1, NULL },
    { PD_REDC, "NeedRedCardForDoor", "PD_REDC", -1, NULL },
    { PD_REDK, "NeedRedForDoor", "PD_REDK", 421, NULL },
    { PD_REDO, "NeedRedForObject", "PD_REDO", 417, NULL },
    { PD_REDS, "NeedRedSkullForDoor", "PD_REDS", -1, NULL },
    { PD_YELLOWC, "NeedYellowCardForDoor", "PD_YELLOWC", -1, NULL },
    { PD_YELLOWK, "NeedYellowForDoor", "PD_YELLOWK", 420, NULL },
    { PD_YELLOWS, "NeedYellowSkullForDoor", "PD_YELLOWS", -1, NULL },
    ...
    { OB_BABY, "OB_Arachnotron", "OB_BABY", -1, NULL },
    { OB_VILE, "OB_Archvile", "OB_VILE", -1, NULL },
    { OB_BARON, "OB_Baron", "OB_BARON", -1, NULL },
    { OB_BARONHIT, "OB_BaronClaw", "OB_BARONHIT", -1, NULL },
    { OB_CACOHIT, "OB_CacoBite", "OB_CACOHIT", -1, NULL },
    { OB_CACO, "OB_Cacodemon", "OB_CACO", -1, NULL },
    { OB_CHAINGUY, "OB_ChaingunGuy", "OB_CHAINGUY", -1, NULL },
    { OB_CYBORG, "OB_Cyberdemon", "OB_CYBORG", -1, NULL },
    { OB_SPIDER, "OB_Mastermind", "OB_SPIDER", -1, NULL },
    { OB_WOLFSS, "OB_WolfSS", "OB_WOLFSS", -1, NULL },
    { OB_DEMONHIT, "OB_Demon", "OB_DEMONHIT", -1, NULL },
    { OB_IMP, "OB_Imp", "OB_IMP", -1, NULL },
    { OB_IMPHIT, "OB_ImpClaw", "OB_IMPHIT", -1, NULL },
    { OB_FATSO, "OB_Mancubus", "OB_FATSO", -1, NULL },
    { OB_UNDEAD, "OB_Revenant", "OB_UNDEAD", -1, NULL },
    { OB_UNDEADHIT, "OB_RevPunch", "OB_UNDEADHIT", -1, NULL },
    { OB_SHOTGUY, "OB_ShotgunGuy", "OB_SHOTGUY", -1, NULL },
    { OB_SKULL, "OB_Skull", "OB_SKULL", -1, NULL },
    { OB_ZOMBIE, "OB_Zombie", "OB_ZOMBIE", -1, NULL },
    { OB_MPCHAINGUN, "OB_Chaingun", "OB_MPCHAINGUN", -1, NULL },
    { OB_MPPISTOL, "OB_Pistol", "OB_MPPISTOL", -1, NULL },
    { OB_MPROCKET, "OB_Missile", "OB_MPROCKET", -1, NULL },
    { OB_MPR_SPLASH, "OB_Missile", "OB_MPR_SPLASH", -1, NULL },
    { OB_MPPLASMARIFLE, "OB_Plasma", "OB_MPPLASMARIFLE", -1, NULL },
    { OB_MPFIST, "OB_Punch", "OB_MPFIST", -1, NULL },
    { OB_MPCHAINSAW, "OB_Saw", "OB_MPCHAINSAW", -1, NULL },
    { OB_MPSHOTGUN, "OB_Shotgun", "OB_MPSHOTGUN", -1, NULL },
    { OB_MPBFG_BOOM, "OB_BFG", "OB_MPBFG_BOOM", -1, NULL },
    { OB_MPBFG_SPLASH, "OB_BFG", "OB_MPBFG_SPLASH", -1, NULL },
    { OB_MPBFG_MBF, "OB_BFG", "OB_MPBFG_MBF", -1, NULL },
