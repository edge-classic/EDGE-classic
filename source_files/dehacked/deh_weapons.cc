...
weaponinfo_t weapon_info[NUMWEAPONS] = {
    {"FIST", am_noammo, 0, 1, 0, "f", S_PUNCHUP, S_PUNCHDOWN, S_PUNCH, S_PUNCH1, S_NULL, 0},
    {"PISTOL", am_bullet, 1, 2, 2, "fr", S_PISTOLUP, S_PISTOLDOWN, S_PISTOL, S_PISTOL1, S_PISTOLFLASH, 0},
    {"SHOTGUN", am_shell, 1, 3, 3, NULL, S_SGUNUP, S_SGUNDOWN, S_SGUN, S_SGUN1, S_SGUNFLASH1, 0},
    {"CHAINGUN", am_bullet, 1, 4, 5, "r", S_CHAINUP, S_CHAINDOWN, S_CHAIN, S_CHAIN1, S_CHAINFLASH1, 0},
    {"ROCKET_LAUNCHER", am_rocket, 1, 5, 6, "d", S_MISSILEUP, S_MISSILEDOWN, S_MISSILE, S_MISSILE1, S_MISSILEFLASH1, 0},
    {"PLASMA_RIFLE", am_cell, 1, 6, 7, NULL, S_PLASMAUP, S_PLASMADOWN, S_PLASMA, S_PLASMA1, S_PLASMAFLASH1, 0},
    {"BFG_9000", am_cell, 40, 7, 8, "d", S_BFGUP, S_BFGDOWN, S_BFG, S_BFG1, S_BFGFLASH1, 0},
    {"CHAINSAW", am_noammo, 0, 1, 1, "bt", S_SAWUP, S_SAWDOWN, S_SAW, S_SAW1, S_NULL, 0},
    {"SUPER_SHOTGUN", am_shell, 2, 3, 4, NULL, S_DSGUNUP, S_DSGUNDOWN, S_DSGUN, S_DSGUN1, S_DSGUNFLASH1, 0},
};
...
const flagname_t mbf21flagnamelist[] = {
    ...
    {MBF21_AUTOSWITCHFROM, "SWITCH", "AUTOSWITCHFROM"},
