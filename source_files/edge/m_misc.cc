...
static default_t defaults[] = {
    ...
    {CFGT_Boolean, "rotate_map", &rotate_map, CFGDEF_ROTATEMAP},
    ...
    {CFGT_Boolean, "automap_keydoor_blink", &automap_keydoor_blink, CFGDEF_AM_KEYDOORBLINK},
    ...
    {CFGT_Key, "key_automap_up", &key_automap_up, KEYD_UPARROW},
    {CFGT_Key, "key_automap_down", &key_automap_down, KEYD_DOWNARROW},
    {CFGT_Key, "key_automap_left", &key_automap_left, KEYD_LEFTARROW},
    {CFGT_Key, "key_automap_right", &key_automap_right, KEYD_RIGHTARROW},
    {CFGT_Key, "key_automap_zoom_in", &key_automap_zoom_in, '='},
    {CFGT_Key, "key_automap_zoom_out", &key_automap_zoom_out, '-'},
    {CFGT_Key, "key_automap_follow", &key_automap_follow, 'f'},
    {CFGT_Key, "key_automap_grid", &key_automap_grid, 'g'},
