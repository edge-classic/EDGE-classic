...
static OptionMenuItem vidoptions[] = {
    ...
    { kOptionMenuItemTypeBoolean, "Map Rotation", YesNo, 2, &rotate_map,
      nullptr, nullptr },
    ...
    { kOptionMenuItemTypeSwitch, "Animated Liquid Type",
      "Vanilla/SMMU/SMMU+Swirl/Parallax", 4, &swirling_flats, nullptr,
      nullptr },
};

static OptionMenuDefinition video_optmenu = { vidoptions,
                                              sizeof(vidoptions) /
                                                  sizeof(OptionMenuItem),
                                              &options_menu_default_style,
                                              150,
...
static OptionMenuItem resoptions[] = {
    { kOptionMenuItemTypePlain, "", nullptr, 0, nullptr, nullptr, nullptr },
    { kOptionMenuItemTypeSwitch, "V-Sync", "Off/Standard/Adaptive", 3,
      &vsync.d_, OptionMenuUpdateConsoleVariableFromInt,
...
static OptionMenuItem analogueoptions[] = {
    ...
    { kOptionMenuItemTypeSlider, "X Sensitivity", nullptr, 0,
      &mouse_x_sensitivity.f_, OptionMenuUpdateConsoleVariableFromFloat,
      nullptr, &mouse_x_sensitivity, 0.25f, 1.0f, 15.0f, "%0.2f" },
    { kOptionMenuItemTypeSlider, "Y Sensitivity", nullptr, 0,
      &mouse_y_sensitivity.f_, OptionMenuUpdateConsoleVariableFromFloat,
      nullptr, &mouse_y_sensitivity, 0.25f, 1.0f, 15.0f, "%0.2f" },
    { kOptionMenuItemTypePlain, "", nullptr, 0, nullptr, nullptr, nullptr },
    ...
    { kOptionMenuItemTypeSlider, "Vertical Look Speed", nullptr, 0,
      &vertical_look_speed.f_, OptionMenuUpdateConsoleVariableFromFloat,
      nullptr, &vertical_look_speed, 0.10f, 0.10f, 3.0f, "%0.2f" },
...
static OptionMenuDefinition analogue_optmenu = { analogueoptions,
                                                 sizeof(analogueoptions) /
                                                     sizeof(OptionMenuItem),
                                                 &options_menu_default_style,
                                                 150,
                                                 75,
...
static OptionMenuItem soundoptions[] = {
    { kOptionMenuItemTypeSlider, "Sound Volume", nullptr, 0,
      &sound_effect_volume.f_, OptionMenuUpdateConsoleVariableFromFloat,
      nullptr, &sound_effect_volume, 0.05f, 0.0f, 1.0f, "%0.2f" },
...
static OptionMenuDefinition sound_optmenu = { soundoptions,
                                              sizeof(soundoptions) /
                                                  sizeof(OptionMenuItem),
                                              &options_menu_default_style,
                                              150,
...
static OptionMenuDefinition f4sound_optmenu = { f4soundoptions,
                                                sizeof(f4soundoptions) /
                                                    sizeof(OptionMenuItem),
                                                &options_menu_default_style,
                                                150,
                                                75,
...
static OptionMenuItem playoptions[] = {
    ...
    { kOptionMenuItemTypeBoolean, "Weapon Kick", YesNo, 2,
      &global_flags.kicking, OptionMenuChangeKicking, nullptr },
    ...
    { kOptionMenuItemTypeBoolean, "Enemy Respawn Mode", "Teleport/Resurrect", 2,
      &global_flags.enemy_respawn_mode, OptionMenuChangeMonsterRespawn,
      nullptr },
...
static OptionMenuItem move_keyconfig[] = {
    { kOptionMenuItemTypeKeyConfig, "Walk Forward", nullptr, 0, &key_up,
      nullptr, nullptr },
...
static OptionMenuItem look_keyconfig[] = {
    { kOptionMenuItemTypeKeyConfig, "Look Up", nullptr, 0, &key_look_up,
      nullptr, nullptr },
...
static OptionMenuItem inventory_keyconfig[] = {
    ...
    { kOptionMenuItemTypeKeyConfig, "Use Item", nullptr, 0, &key_inventory_use,
      nullptr, nullptr },
    { kOptionMenuItemTypeKeyConfig, "Next Item", nullptr, 0,
      &key_inventory_next, nullptr, nullptr },
};

static OptionMenuDefinition inventory_optmenu = { inventory_keyconfig,
                                                  sizeof(inventory_keyconfig) /
                                                      sizeof(OptionMenuItem),
                                                  &options_menu_default_style,
                                                  140,
                                                  98,
...
static OptionMenuItem program_keyconfig1[] = {
    { kOptionMenuItemTypeKeyConfig, "Screenshot", nullptr, 0, &key_screenshot,
      nullptr, nullptr },
    { kOptionMenuItemTypeKeyConfig, "Console", nullptr, 0, &key_console,
      nullptr, nullptr },
