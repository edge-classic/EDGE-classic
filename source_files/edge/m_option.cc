...
static OptionMenuItem vidoptions[] = {
    ...
    { kOptionMenuItemTypeSwitch, "Sector Brightness", "-50/-40/-30/-20/-10/Default/+10/+20/+30/+40/+50", 11,
      &sector_brightness_correction.d_, OptionMenuUpdateConsoleVariableFromInt, nullptr,
      &sector_brightness_correction },
    ...
    { kOptionMenuItemTypeSwitch, "Animated Liquid Type", "Vanilla/SMMU/SMMU+Swirl/Parallax", 4, &swirling_flats,
      nullptr, nullptr },
};
...
static OptionMenuItem resoptions[] = {
    ...
    { kOptionMenuItemTypeSwitch, "V-Sync", "Off/Standard/Adaptive", 3, &vsync.d_,
      OptionMenuUpdateConsoleVariableFromInt, "Will fallback to Standard if Adaptive is not supported", &vsync },
...
static OptionMenuItem analogueoptions[] = {
    ...
    { kOptionMenuItemTypeSlider, "Side Move Speed", nullptr, 0, &side_speed.f_,
      OptionMenuUpdateConsoleVariableFromFloat, nullptr, &side_speed, 0.10f, 0.10f, 3.0f, "%0.2f" },
};
...
static OptionMenuItem playoptions[] = {
    ...
    { kOptionMenuItemTypeSwitch, "Autoaim", "Off/On/Mlook", 3, &global_flags.autoaim, OptionMenuChangeAutoAim,
      nullptr },
...
static OptionMenuDefinition *all_key_menus[NUM_KEY_MENUS] = {
    &movement_optmenu, &attack_optmenu,    &look_optmenu,     &otherkey_optmenu, &weapon_optmenu,
    &automap_optmenu,  &inventory_optmenu, &program_optmenu1, &program_optmenu2
};
