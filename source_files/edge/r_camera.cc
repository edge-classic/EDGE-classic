...
camera_c::camera_c(const camera_c &other) : FOV(other.FOV), pos(other.pos), turn(other.turn), mlook(other.mlook)
{
...
void camera_c::Recalculate()
{
    ...
    float aspect = ASPECT_RATIO * (float(viewwindow_h) / SCREENHEIGHT) / (float(viewwindow_w) / SCREENWIDTH);
    ...
    L_WriteDebug("  Raw vectors: L=(%1.3f,%1.3f,%1.3f) R=(%1.3f,%1.3f,%1.3f)\n", left_v.x, left_v.y, left_v.z,
                 right_v.x, right_v.y, right_v.z);
    L_WriteDebug("               T=(%1.3f,%1.3f,%1.3f) B=(%1.3f,%1.3f,%1.3f)\n", top_v.x, top_v.y, top_v.z, bottom_v.x,
                 bottom_v.y, bottom_v.z);
#endif
    ...
    L_WriteDebug("  Final vectors: L=(%1.3f,%1.3f,%1.3f) R=(%1.3f,%1.3f,%1.3f)\n", left_v.x, left_v.y, left_v.z,
                 right_v.x, right_v.y, right_v.z);
    L_WriteDebug("                 T=(%1.3f,%1.3f,%1.3f) B=(%1.3f,%1.3f,%1.3f)\n", top_v.x, top_v.y, top_v.z,
                 bottom_v.x, bottom_v.y, bottom_v.z);
