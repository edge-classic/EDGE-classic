...
{
    float timeScale = game_tic / (double_framerate.d_? 200.0f : 100.0f);
...
static void RGL_DrawSubsector(drawsub_c *dsub, bool mirror_sub)
{
    ...
    for (dfloor = dsub->floors_R; dfloor != nullptr; dfloor = dfloor->next_R)
    {
