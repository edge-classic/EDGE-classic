...
bool M4PPlayer::OpenMemory(uint8_t *data, int length)
{
    ...
    if (ma_sound_init_from_data_source(&music_engine, &m4p_decoder_, MA_SOUND_FLAG_UNKNOWN_LENGTH|MA_SOUND_FLAG_STREAM|MA_SOUND_FLAG_NO_SPATIALIZATION, NULL, &m4p_stream_) != MA_SUCCESS)
    {
