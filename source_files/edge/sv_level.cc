...
static SaveField sv_fields_regprops[] = {
    ...
    EDGE_SAVE_FIELD(dummy_region_properties, push, "push", 1, kSaveFieldNumeric, 12, nullptr, SaveGameGetVec3,
                    SaveGamePutVec3),
    EDGE_SAVE_FIELD(dummy_region_properties, push_constant, "push_constant", 1, kSaveFieldNumeric, 12, nullptr,
                    SaveGameGetBoolean, SaveGamePutBoolean),
...
static SaveField sv_fields_sector[] = {
    ...
    EDGE_SAVE_FIELD(dummy_sector, ceiling_height, "c_h", 1, kSaveFieldNumeric, 4, nullptr, SaveGameGetFloat,
                    SaveGamePutFloat),
    EDGE_SAVE_FIELD(dummy_sector, interpolated_floor_height, "i_f_h", 1, kSaveFieldNumeric, 4, nullptr,
                    SaveGameGetFloat, SaveGamePutFloat),
    EDGE_SAVE_FIELD(dummy_sector, interpolated_ceiling_height, "i_c_h", 1, kSaveFieldNumeric, 4, nullptr,
                    SaveGameGetFloat, SaveGamePutFloat),
    EDGE_SAVE_FIELD(dummy_sector, old_floor_height, "o_f_h", 1, kSaveFieldNumeric, 4, nullptr, SaveGameGetFloat,
                    SaveGamePutFloat),
    EDGE_SAVE_FIELD(dummy_sector, old_ceiling_height, "o_c_h", 1, kSaveFieldNumeric, 4, nullptr, SaveGameGetFloat,
                    SaveGamePutFloat),
