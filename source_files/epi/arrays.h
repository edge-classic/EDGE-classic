...
class array_iterator_c
{
  ...
  public:
    int GetPos()
    {
        return idx ? idx / parent->array_block_objsize : 0;
    }
    ...
    void SetPos(int pos)
    {
        idx = pos * parent->array_block_objsize;
    }
...
#define ITERATOR_TO_PTR(_it, _type) ((_type *)((void *)(_it)))

#define ITERATOR_TO_TYPE(_it, _type) (*(_type *)((void *)(_it)))
