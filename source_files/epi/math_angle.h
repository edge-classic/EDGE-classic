...
class angle_c
{
  ...
  public:
    ...
    inline bool Less180() const
    {
        return (bam & 0x80000000) ? false : true;
    }
    inline bool More180() const
    {
        return (bam & 0x80000000) ? true : false;
    }
    inline bool Less90() const
    {
        return (bam & 0xC0000000) ? false : true;
    }
    inline bool More90() const
    {
        return (bam & 0xC0000000) ? true : false;
    }

    inline bool operator<(const angle_c &rhs) const
    {
        return bam < rhs.bam;
    }
    inline bool operator>(const angle_c &rhs) const
    ...
    inline angle_c &Add180()
    {
        bam ^= 0x80000000;
        return *this;
    }
    inline angle_c &Add90()
    {
        bam += 0x40000000;
        return *this;
    }
    inline angle_c &Sub90()
    {
        bam -= 0x40000000;
        return *this;
    }
    ...
    static inline angle_c Ang0()
    {
        return angle_c(0x00000000, false);
    }
    static inline angle_c Ang15()
    {
        return angle_c(0x0AAAAAAA, false);
    }
    static inline angle_c Ang30()
    {
        return angle_c(0x15555555, false);
    }
    static inline angle_c Ang45()
    {
        return angle_c(0x20000000, false);
    }
    static inline angle_c Ang60()
    {
        return angle_c(0x2AAAAAAA, false);
    }
    static inline angle_c Ang90()
    {
        return angle_c(0x40000000, false);
    }
    static inline angle_c Ang145()
    {
        return angle_c(0x60000000, false);
    }
    static inline angle_c Ang180()
    {
        return angle_c(0x80000000, false);
    }
    static inline angle_c Ang225()
    {
        return angle_c(0xA0000000, false);
    }
    static inline angle_c Ang270()
    {
        return angle_c(0xC0000000, false);
    }
    static inline angle_c Ang315()
    {
        return angle_c(0xE0000000, false);
    }
    static inline angle_c Ang360()
    {
        return angle_c(0xFFFFFFFF, false);
    }
};
...
inline angle_c::angle_c(float deg) : bam((u32_t)((deg < 0 ? (deg + 360.0) : double(deg)) * 11930464.7084))
{
    /* nothing needed */
}
...
{
    return (bam >= other.bam) ? angle_c(bam - other.bam, false) : angle_c(other.bam - bam, false);
}
