...
void OPL3_StreamStereo(opl3_chip *chip, int16_t *sndptr, uint32_t numsamples)
{
    uint_fast32_t i;
...
void OPL3_StreamMono(opl3_chip *chip, int16_t *sndptr, uint32_t numsamples)
{
    uint32_t i;
    ...
    for(i = 0; i < numsamples; i++)
    {
        ...
        int32_t sum = (int32_t)samples[0] + (int32_t)samples[1];

        *sndptr++ = (int16_t)(sum >> 1);
    }
}
